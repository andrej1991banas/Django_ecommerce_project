...
class CrudMemberTestCase(TestCase):
    ...
    def test_member_creation(self):
        ...
        self.assertEqual(self.member.address1, "TestAddress") #actual Member data
    ...
    def test_member_str_method(self):
        ...
        self.assertEqual(str(self.member),"andrej@test.com" )
    ...
    def test_member_update_method(self):
        ...
        member= Member.objects.get(zipcode="10001")
    ...
    def test_member_delete_method(self):
        ...
        self.assertFalse(Member.objects.filter(zipcode="10001").exists()) #check if the wuerry of Members is empty
